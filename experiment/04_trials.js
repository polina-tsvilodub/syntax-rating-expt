...
const main_trials = {
    dogs1:   {
            ...
            text: "You see another member of the group." ,
            target: items.dogs1[size[0]].target,
            question: "You want to talk to your friend about the new member. Please rate how likely you are to use the sentences below to address your friend:",
            domain: "dogs1",
