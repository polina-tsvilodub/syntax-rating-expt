...
const main_trials = {
    dogs1:   {
            ...
            text: "You see this other member of the group." ,
            target: items.dogs1[size[0]].target,
            question: "How well does each of these sentences describe this new member? (Click on the slider to provide a rating)",
            domain: "dogs1",
